...
namespace ECommerce.API.Migrations
{
    ...
    [Migration("20250625025002_AddProductNameUnsignedToProducts")]
    partial class AddProductNameUnsignedToProducts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.API.Models.Domain.ChatMessage", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.API.Models.Domain.Conversations", b =>
                {
                    b.Property<Guid>("ConversationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ECommerce.API.Models.Domain.ExtendedIdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3599ee7c-cc02-4028-acdf-f85682193b6f",
                            Email = "superadmin@ecommerce.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "SUPERADMIN@ECOMMERCE.COM",
                            NormalizedUserName = "SUPERADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEF8MXbZLoWIFp7C/P2XnVEbrp9Trca6ofhnzfO9I2GrdEzi9Rcxj2cNs5E3ohPfxYw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e46bafb1-c4ca-4d7d-855b-10f31af4c4aa",
            ...
            modelBuilder.Entity("ECommerce.API.Models.Domain.ChatMessage", b =>
                {
                    b.HasOne("ECommerce.API.Models.Domain.Conversations", "Conversation")
                        .WithMany("ChatMessages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce.API.Models.Domain.ExtendedIdentityUser", "Sender")
            ...
            modelBuilder.Entity("ECommerce.API.Models.Domain.Conversations", b =>
                {
                    b.HasOne("ECommerce.API.Models.Domain.ExtendedIdentityUser", "AdminUser")
                        .WithMany("AdminAssignedConversations")
                        .HasForeignKey("AdminUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ECommerce.API.Models.Domain.ExtendedIdentityUser", "ClientUser")
